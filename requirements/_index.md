...
| REQ-080 | Fix: Config-Only Container Disappears After docker compose up            | High   | Planned       | 2026-05-18 | [2026-05-18-fix-config-only-recreate.md](2026-05-18-fix-config-only-recreate.md) |
